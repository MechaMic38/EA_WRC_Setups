...
interface SetupDeleteModalProps {
    isOpen: boolean;
    setup: Setup | null;
    onClose: () => void;
    onSuccess: () => void;
...
export default function SetupDeleteModal({
    isOpen,
    setup,
    onClose,
    onSuccess,
}: SetupDeleteModalProps) {
    const { delete: deleteSetup, isProcessing } = useAxiosForm<void>([]);
    ...
    const handleDelete = () => {
        ...
        deleteSetup(route("api.setups.destroy", { setup: setup.id }), {
            onSuccess: () => {
                onSuccess();
                onClose();
            },
            onError: (error) => {
                ...
                setErrorMessage(
                    error.response?.data?.message ||
                        "An error occurred while deleting the setup. Please try again."
                );
            },
        });
    };
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-onSurface/70 mb-4">
                                This action cannot be undone. The setup will be
                                permanently removed.
                            </p>
                        </div>
                        ...
                        <div className="p-4 bg-red-500/5 rounded-xl border border-red-500/20">
                            <div className="flex items-start">
                                ...
                                <p className="text-sm text-onSurface/80">
                                    ...
                                    permanently remove this setup from the
                    ...
                    <div className="p-6 pt-0">
                        <div className="flex justify-end space-x-3">
                            ...
                            >
                                ...
                                {isProcessing ? "Deleting..." : "Delete Setup"}
                            </button>
                        </div>
                    </div>
                </div>
