                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-onSurface/70 mb-4">
                                This action cannot be undone. All setups and
                                data associated with this location will be
                        ...
                        <div className="p-4 bg-red-500/5 rounded-xl border border-red-500/20">
                            <div className="flex items-start">
                                ...
                                <p className="text-sm text-onSurface/80">
                                    ...
                                    permanently delete all setups, and other
                                    data associated with this location. This
