...
interface ManufacturerListboxProps {
    options: Manufacturer[];
    selectedOption: Manufacturer | null;
    placeholder?: string;
    error?: string | null;
    onChange: (option: Manufacturer | null) => void;
}

export default function ManufacturerListbox({
    options,
    selectedOption,
    placeholder = "Select a manufacturer",
    error = null,
    onChange,
}: ManufacturerListboxProps) {
    return (
