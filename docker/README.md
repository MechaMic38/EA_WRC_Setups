...
This is a pretty simplified, but complete, workflow for using Docker and Docker Compose with Laravel development. The included docker-compose.yml file, Dockerfiles, and config files, set up a LEMPg stack powering a Laravel application in the `src` directory.
...
-   `COMPOSE_PROJECT_NAME=ea_wrc_setups` Used in the docker-compose.yml file to namespace the services.
